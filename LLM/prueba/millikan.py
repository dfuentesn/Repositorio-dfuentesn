...
plt.plot(x_ajuste, y_ajuste, label="y = (4.09e-15 ± 5.25e-17)x - (1.73 ± 4.47e-02)", color="red")
plt.plot([], [], ' ', label="h = 6.5500623482963051e-34 J·s") 
plt.plot([], [], ' ', label="En julios Φ = 2.7737455530831321e-19 J") 
plt.plot([], [], ' ', label="En voltios Φ = 1.7312358039813558e+00 V") 
