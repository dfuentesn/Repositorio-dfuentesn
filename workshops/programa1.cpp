...
int main(int argc, char **argv){
    ...
    //verifica que el número de argumentos sea el nombre y el argumento (osea 2), si no se cumple, muestra un mensaje de error
    if (argc != 2){
        std::cerr << "Uso: " << argv[0] << " <numero>" << "\n";
        return 1; //acá el 1 actua como false solo que sin ser booleano (no hay funcion bool)
    }
